...
export const translations = {
  en: {
    ...
    aboutHistory:
      "Established in 1994, Jay Bhawani Secondary School is located in Ward No. 7 of Hilihang Rural Municipality in Panchthar District, Koshi Province. The school was founded through the collective efforts of local parents who recognized the importance of education and worked together to create a learning institution in an accessible location.",
    aboutMission:
      "Our team of experienced teachers works tirelessly to inspire and motivate students to achieve their full potential. We strive to create a welcoming and inclusive school culture that fosters a love of learning, creativity, and collaboration.",
    aboutVision:
      "We are committed to empowering students to become lifelong learners who are equipped with the 21st-century skills and knowledge they need to succeed in a rapidly changing world.",
    ...
    event2Desc:
      "Students showcasing innovative science projects and experiments",
    ...
    bannerSubtitle:
      "Building knowledge, values, and skills for a brighter future",
    ...
    blog1Excerpt:
      "Discover how participation in extracurricular activities contributes to holistic development and future success.",
    blog1Author: "Principal Sharma",

    blog2Title: "Celebrating Cultural Diversity in Education",
    blog2Date: "March 15, 2025",
    blog2Excerpt:
      "How our multicultural approach to education helps students develop global perspectives and cultural sensitivity.",
    blog2Author: "Rajesh Thapa",

    blog3Title: "Technology Integration in Classrooms",
    blog3Date: "March 5, 2025",
    blog3Excerpt:
      "Exploring innovative ways we're using technology to enhance learning experiences for our students.",
    blog3Author: "Sunita Rai",

    // Staff page
    staffsTitle: "Meet Our Staff",
    staffsSubtitle:
      "The dedicated educators and professionals who make our school exceptional",

    // Management Team page
    managementTitle: "School Management Committee",
    managementSubtitle:
      "The dedicated team responsible for the governance and management of our school",
    ...
    landDonorsSubtitle:
      "Generous individuals who donated land to Jay Bhawani Secondary School",
    principalsHeading: "Former Principals",
    principalsSubtitle:
      "Leaders who have guided our institution through the years",
    ...
    footerAboutText:
      "Jay Bhawani Secondary School is committed to providing quality education that develops character, knowledge, and skills for a brighter future.",
    footerContactTitle: "Contact Information",
    footerAddress: "Hilihang-07, Panchthar, Nepal",
    ...
    aboutUsNamingContent:
      "Along with the operation of the school, it was named 'Shree Jay Bhawani' after the name of God.",
    aboutUsGrowth: "Growth and Development",
    aboutUsGrowthContent:
      "Subsequently, more than a dozen government and private teachers have been found teaching. The school has been upgraded with the tireless efforts, activism, and struggle of the guardians to raise financial and physical resources, and with building grants from donor agencies, the District Education Office, and the Village Development Committee.",
    aboutUsVision: "Our Vision",
    aboutUsVisionContent:
      "To be a center of academic excellence that nurtures well-rounded, responsible citizens who contribute positively to society.",
    aboutUsMission: "Our Mission",
    aboutUsMissionContent:
      "To provide quality education in a supportive environment that promotes intellectual curiosity, personal growth, and social responsibility.",
    aboutUsValues: "Core Values",
    aboutUsValuesExcellence: "Excellence",
    aboutUsValuesExcellenceContent:
      "Striving for the highest standards in academic and personal achievement",
    aboutUsValuesIntegrity: "Integrity",
    aboutUsValuesIntegrityContent:
      "Upholding honesty, ethics, and transparency in all actions",
    aboutUsValuesRespect: "Respect",
    aboutUsValuesRespectContent:
      "Fostering a culture of mutual respect, inclusivity, and appreciation of diversity",
    aboutUsValuesInnovation: "Innovation",
    aboutUsValuesInnovationContent:
      "Encouraging creative thinking and innovative approaches to learning and problem-solving",
    aboutUsValuesCommunity: "Community",
    aboutUsValuesCommunityContent:
      "Building strong partnerships between the school, families, and the wider community",
  },
  np: {
    // TopBar translations
    phone: "+१२३-४५६-७८९०",
    ...
    aboutHistory:
      "कोशी प्रदेश पाँचथर जिल्ला अन्तरगत हिलिहाङ गाउँपालिका वडा नं. ७ मा पर्ने यस श्री जय भवानी माध्यमिक विद्यालयको स्थापना वि. सं. २०४४ सालमा भएको थियो। विद्यालय स्थापना गर्ने क्रममा स्थानीय अभिभावकहरुले शिक्षाको महत्त्व बुझि पायक पर्ने स्थानमा घाँसे झाडी फँडानी गरी भिरालो फरेको जग्गालाई सम्याउँदै सम्पुर्ण अभिभावकहरुको सक्रियतामा विद्यालय सञ्चालन गरीएको थियो ।",
    aboutMission:
      "हाम्रो अनुभवी शिक्षकहरूको टोलीले विद्यार्थीहरूलाई उनीहरूको पूर्ण क्षमता हासिल गर्न प्रेरित र प्रोत्साहित गर्न अथक प्रयास गर्दछ। हामी सिक्ने, सृजनात्मकता र सहकार्यको प्रेमलाई बढावा दिने स्वागतयोग्य र समावेशी विद्यालय संस्कृति सिर्जना गर्न प्रयास गर्दछौं।",
    aboutVision:
      "हामी विद्यार्थीहरूलाई आजीवन सिकारु बन्न सशक्त बनाउन प्रतिबद्ध छौं जो तीव्र गतिमा परिवर्तन हुँदै गरेको संसारमा सफल हुन आवश्यक २१ औं शताब्दीको सीप र ज्ञानले सुसज्जित छन्।",
    ...
    event2Desc:
      "विद्यार्थीहरूले नवीन विज्ञान परियोजना र प्रयोगहरू प्रदर्शन गर्दै",
    ...
    event4Desc:
      "प्रतिभाशाली विद्यार्थी प्रस्तुतिहरू समावेश गरिएको वार्षिक संगीत कार्यक्रम",

    event5Title: "वक्तृत्वकला प्रतियोगिता",
    event5Date: "जनवरी १०, २०२५",
    event5Desc:
      "विभिन्न समसामयिक विषयहरूमा अन्तर-कक्षा वक्तृत्वकला प्रतियोगिता",
    ...
    blog1Excerpt:
      "अतिरिक्त क्रियाकलापहरूमा सहभागिताले कसरी समग्र विकास र भविष्यको सफलतामा योगदान पुर्‍याउँछ भन्ने पत्ता लगाउनुहोस्।",
    blog1Author: "प्रधानाध्यापक शर्मा",

    blog2Title: "शिक्षामा सांस्कृतिक विविधताको उत्सव",
    blog2Date: "मार्च १५, २०२५",
    blog2Excerpt:
      "शिक्षाको हाम्रो बहुसांस्कृतिक दृष्टिकोणले विद्यार्थीहरूलाई वैश्विक दृष्टिकोण र सांस्कृतिक संवेदनशीलता विकास गर्न कसरी मद्दत गर्दछ।",
    blog2Author: "राजेश थापा",

    blog3Title: "कक्षाकोठामा प्रविधि एकीकरण",
    blog3Date: "मार्च ५, २०२५",
    blog3Excerpt:
      "हाम्रा विद्यार्थीहरूको लागि सिकाइ अनुभवहरू बढाउन हामीले प्रविधि प्रयोग गर्ने नवीन तरिकाहरू अन्वेषण गर्द।",
    blog3Author: "सुनिता राई",

    // Staff page
    staffsTitle: "हाम्रा कर्मचारीहरूसँग भेट्नुहोस्",
    staffsSubtitle:
      "समर्पित शिक्षक र पेशेवरहरू जसले हाम्रो विद्यालयलाई उत्कृष्ट बनाउँछन्",

    // Management Team page
    managementTitle: "विद्यालय व्यवस्थापन समिति",
    managementSubtitle:
      "हाम्रो विद्यालयको शासन र व्यवस्थापनको लागि जिम्मेवार समर्पित टोली",
    ...
    landDonorsSubtitle:
      "जय भवानी माध्यमिक विद्यालयलाई जग्गा दान गर्ने उदार व्यक्तिहरू",
    principalsHeading: "पूर्व प्रधानाध्यापकहरू",
    principalsSubtitle:
      "वर्षौंदेखि हाम्रो संस्थालाई मार्गदर्शन गर्ने नेतृत्वकर्ताहरू",
    chairpersonsHeading: "पूर्व अध्यक्षहरू",
    chairpersonsSubtitle:
      "हाम्रो विद्यालय व्यवस्थापन समितिका पूर्व नेतृत्वकर्ताहरू",
    serialNumber: "क्र.सं.",
    name: "नाम",
    position: "पद",
    address: "ठेगाना",
    ...
    footerAboutText:
      "जय भवानी माध्यमिक विद्यालय उज्यालो भविष्यको लागि चरित्र, ज्ञान र सीपहरू विकास गर्ने गुणस्तरीय शिक्षा प्रदान गर्न प्रतिबद्ध छ।",
    ...
    aboutUsFoundersContent:
      "विशेष गरी स्थानिय अभिभावक चक्रबहादुर राई, टंकनाथ तिम्सिना, छत्र बहादुर एक्तिनहाङ, पदमलाल रिजाल, जीवनाथ रिजाल, पुर्ण बहादुर थापा, कृष्ण बहादुर सुवेदी, रुद्र प्रसाद पौड्याल, तिलचन तिम्सिना, अम्विका प्रसाद रिजाल, खेम प्रसाद रिजाल, विर बहादुर राई, धन कुमार राई, रुद्र राई, कुमार राई, गोमा देवी रिजाल, पुन्य प्रसाद रिजाल, नरेन्द्र एक्तिनहाङ, सहर बहादुर राई, शक्तिमान राई आदीको अगुवाईमा एकतले घर बनाई विद्यालय सञ्चालन भएको पाईन्छ ।",
    aboutUsNaming: "विद्यालयको नामाकरण",
    aboutUsNamingContent:
      "विद्यालय सञ्चालन सँगसँगै भगवानको नामबाट विद्यालयको नाम श्री जय भवानी नामाकरण गरीएको थियो ।",
    aboutUsGrowth: "विकास र प्रगति",
    aboutUsGrowthContent:
      "तत्पश्चात सरकारी र निजी गरी करीव एक दर्जन भन्दा बढी शिक्षकहरुले अध्यापन गरेको पाईन्छ । अभिभावकको अथक प्रयास, सक्रियता र संघर्षमा आर्थिक तथा भौतिक साधनहरु जुटाउँदै दातृ निकायहरु जिल्ला शिक्षा कार्यालय र गाउँविकास समितिको भवन अनुदानमा भवन निर्माण गर्दै विद्यालय अप-ग्रेडिङ भएको छ ।",
    aboutUsVision: "हाम्रो दृष्टि",
    aboutUsVisionContent:
      "समाजमा सकारात्मक योगदान पुर्‍याउने जिम्मेवार नागरिकहरू तयार गर्ने शैक्षिक उत्कृष्टताको केन्द्र बन्ने ।",
    aboutUsMission: "हाम्रो लक्ष्य",
    aboutUsMissionContent:
      "बौद्धिक जिज्ञासा, व्यक्तिगत विकास र सामाजिक जिम्मेवारीलाई प्रोत्साहन गर्ने सहयोगी वातावरणमा गुणस्तरीय शिक्षा प्रदान गर्ने ।",
    aboutUsValues: "मूल मान्यताहरू",
    aboutUsValuesExcellence: "उत्कृष्टता",
    aboutUsValuesExcellenceContent:
      "शैक्षिक र व्यक्तिगत उपलब्धिमा उच्चतम मापदण्डको लागि प्रयासरत",
    aboutUsValuesIntegrity: "सत्यनिष्ठा",
    aboutUsValuesIntegrityContent:
      "सबै कार्यहरूमा इमानदारी, नैतिकता र पारदर्शिता कायम राख्ने",
    aboutUsValuesRespect: "सम्मान",
    aboutUsValuesRespectContent:
      "आपसी सम्मान, समावेशिता र विविधताको सराहनाको संस्कृति विकास गर्ने",
    aboutUsValuesInnovation: "नवीनता",
    aboutUsValuesInnovationContent:
      "सिकाइ र समस्या समाधानमा सिर्जनात्मक सोच र नवीन दृष्टिकोणलाई प्रोत्साहन गर्ने",
    aboutUsValuesCommunity: "समुदाय",
    aboutUsValuesCommunityContent:
      "विद्यालय, परिवारहरू र समग्र समुदायबीच बलियो साझेदारी निर्माण गर्ने",
  },
};
